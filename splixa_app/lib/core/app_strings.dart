...
class AppStrings {
  ...
  static const Map<String, Map<AppLanguage, String>> values = {
    ...
    // --- Auth: login ---
    'login_title': {
      AppLanguage.tr: 'Splixa Giriş',
      AppLanguage.en: 'Splixa Login',
    },
    ...
    'login_welcome': {
      AppLanguage.tr: 'Splixa uygulamasina hos geldin',
      AppLanguage.en: 'Welcome to Splixa',
    },
    'login_identifier_subtitle': {
      AppLanguage.tr:
          'E-posta adresin veya kullanici adin ve sifrenle giris yap.',
      AppLanguage.en: 'Sign in with your email or username and password.',
    },
    'login_identifier_label': {
      AppLanguage.tr: 'E-posta veya kullanici adi',
      AppLanguage.en: 'Email or username',
    },
    'login_identifier_hint': {
      AppLanguage.tr: 'ornek@posta.com veya @kullanici',
      AppLanguage.en: 'you@example.com or @username',
    },
    'login_identifier_required': {
      AppLanguage.tr: 'E-posta veya kullanici adini gir.',
      AppLanguage.en: 'Enter your email or username.',
    },

    // --- Auth: register ---
    'register_title': {
      AppLanguage.tr: 'Splixa Kayıt Ol',
      AppLanguage.en: 'Splixa Sign Up',
    },
    ...
    'forgot_password_sent_message': {
      AppLanguage.tr: 'E-postanıza 8 haneli bir kurtarma kodu gönderildi.',
      AppLanguage.en: 'An 8-digit recovery code has been sent to your email.',
    },
    ...
    'forgot_password_send_link': {
      AppLanguage.tr: 'Kurtarma Kodu Gönder',
      AppLanguage.en: 'Send recovery code',
    },
    ...
    'login_verification_title': {
      AppLanguage.tr: '2 Adımlı Doğrulama',
      AppLanguage.en: '2-Step Verification',
    },
    'login_verification_prompt': {
      AppLanguage.tr:
          '{email} adresine gönderilen 8 haneli doğrulama kodunu girin.',
      AppLanguage.en: 'Enter the 8-digit verification code sent to {email}.',
    },
    'login_verification_submit': {
      AppLanguage.tr: 'Doğrula ve Giriş Yap',
      AppLanguage.en: 'Verify and log in',
    },
    'auth_code_label': {
      AppLanguage.tr: '8 Haneli Kod',
      AppLanguage.en: '8-digit code',
    },
    'auth_code_eight_digits_required': {
      AppLanguage.tr: 'Kod 8 haneli olmalıdır.',
      AppLanguage.en: 'The code must be 8 digits.',
    },
    'auth_code_resend': {
      AppLanguage.tr: 'Kodu Tekrar Gönder',
      AppLanguage.en: 'Resend code',
    },
    'auth_code_resending': {
      AppLanguage.tr: 'Gönderiliyor...',
      AppLanguage.en: 'Sending...',
    },
    'auth_code_resent': {
      AppLanguage.tr: 'Yeni doğrulama kodu e-postanıza gönderildi.',
      AppLanguage.en: 'A new verification code was sent to your email.',
    },
    'auth_code_invalid_or_expired': {
      AppLanguage.tr: 'Kod geçersiz veya süresi dolmuş.',
      AppLanguage.en: 'The code is invalid or has expired.',
    },
    'reset_password_code_title': {
      AppLanguage.tr: 'Şifreyi Sıfırla',
    ...
    'reset_password_code_submit': {
      AppLanguage.tr: 'Kodu Doğrula ve Şifreyi Güncelle',
      AppLanguage.en: 'Verify code and update password',
    },
    ...
    'profile_bio_label': {AppLanguage.tr: 'Hakkimda', AppLanguage.en: 'Bio'},
    'profile_bio_hint': {
      AppLanguage.tr: 'Kendinden kisaca bahset...',
      AppLanguage.en: 'Tell people a little about yourself...',
    },
    'profile_bio_empty': {
      AppLanguage.tr: 'Henuz bir biyografi eklenmedi.',
      AppLanguage.en: 'No bio added yet.',
    },
    ...
    'paywall_title': {
      AppLanguage.tr: "Splixa Pro'ya Geç",
      AppLanguage.en: 'Upgrade to Splixa Pro',
    },
    'paywall_subtitle': {
      AppLanguage.tr:
    ...
    'paywall_welcome_pro': {
      AppLanguage.tr: "Splixa Pro'ya hoş geldiniz!",
      AppLanguage.en: 'Welcome to Splixa Pro!',
    },
