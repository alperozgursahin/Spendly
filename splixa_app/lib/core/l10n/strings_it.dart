...
const Map<String, String> itStrings = {
  ...
  'statistics_monthly_trend': 'Spesa mensile',
  'statistics_total': 'Totale',
  'statistics_daily_average': 'Media giornaliera',
  'statistics_largest': 'Spesa maggiore',
  ...
  'groups_custom_rate_base_currency': 'La valuta scelta è già la valuta base.',
  'groups_custom_rate_label': '1 {code} = ? TRY',
  'groups_custom_rate_live': 'Tasso attuale: {rate}',
  ...
  'groups_expense_category_label': 'Categoria',
  ...
  'groups_already_member': 'Già nel gruppo',
  ...
  'other_profile_member_new': 'Iscritto questo mese',
  'other_profile_member_months': '{months} mesi su Splixa',
  'other_profile_member_years': '{years} anni su Splixa',
  'other_profile_shared_groups_title': 'Gruppi in comune',
  ...
  'paywall_save_percent': 'RISPARMIA {percent}%',
  'paywall_start_trial_cta': 'Inizia la prova gratuita di {days} giorni',
  'paywall_start_trial_cta_generic': 'Inizia la prova gratuita',
  'paywall_trust_cancel': 'Disdici quando vuoi',
  'paywall_trust_no_charge': 'Nessun addebito oggi',
  'paywall_trust_store': 'Pagamento sicuro tramite il tuo store',
  ...
  'pro_category_name_helper': 'Puoi aggiungere un emoji al nome, se vuoi',
  ...
  'pro_recurring_start_date': 'Data di inizio',
  'pro_recurring_explainer_weekly': 'La prima il {date}, poi ogni settimana.',
  'pro_recurring_explainer_monthly': 'La prima il {date}, poi ogni mese.',
  'pro_recurring_empty':
  ...
  'trip_summary_settled_up': 'Sono tutti in pari',
  'trip_summary_who_owes': 'Chi deve a chi',
  'trip_summary_expenses_title': 'Spese',
  'trip_summary_people': '{count} persone',
  'trip_summary_expenses_count': '{count} spese',
  'trip_summary_more': '+{count} altre',
  'pro_trip_share': 'Condividi riepilogo',
  'statistics_current_month': 'Mese corrente',
  'paywall_free_trial': '7 GIORNI GRATIS',
  'paywall_free_trial_days': 'PROVA GRATUITA DI {days} GIORNI',
  'paywall_free_trial_generic': 'PROVA GRATUITA',
