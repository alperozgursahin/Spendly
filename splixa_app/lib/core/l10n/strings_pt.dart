...
const Map<String, String> ptStrings = {
  ...
  'statistics_monthly_trend': 'Gasto mensal',
  'statistics_total': 'Total',
  'statistics_daily_average': 'Média diária',
  'statistics_largest': 'Maior despesa',
  ...
  'groups_custom_rate_base_currency': 'A moeda selecionada já é a moeda base.',
  'groups_custom_rate_label': '1 {code} = ? TRY',
  'groups_custom_rate_live': 'Taxa atual: {rate}',
  ...
  'groups_already_member': 'Já está no grupo',
  ...
  'other_profile_member_new': 'Entrou este mês',
  'other_profile_member_months': '{months} meses no Splixa',
  'other_profile_member_years': '{years} anos no Splixa',
  'other_profile_shared_groups_title': 'Grupos em comum',
  ...
  'paywall_save_percent': 'ECONOMIZE {percent}%',
  'paywall_start_trial_cta': 'Começar meu teste grátis de {days} dias',
  'paywall_start_trial_cta_generic': 'Começar meu teste grátis',
  'paywall_trust_cancel': 'Cancele quando quiser',
  'paywall_trust_no_charge': 'Nada é cobrado hoje',
  'paywall_trust_store': 'Pagamento seguro pela sua loja de apps',
  ...
  'pro_category_name_helper': 'Você pode adicionar um emoji ao nome, se quiser',
  ...
  'pro_recurring_start_date': 'Data de início',
  'pro_recurring_explainer_weekly': 'O primeiro em {date}, depois toda semana.',
  'pro_recurring_explainer_monthly': 'O primeiro em {date}, depois todo mês.',
  'pro_recurring_empty':
  ...
  'trip_summary_settled_up': 'Todos estão quites',
  'trip_summary_who_owes': 'Quem deve a quem',
  'trip_summary_expenses_title': 'Despesas',
  'trip_summary_people': '{count} pessoas',
  'trip_summary_expenses_count': '{count} despesas',
  'trip_summary_more': '+{count} mais',
  'pro_trip_share': 'Compartilhar resumo',
  'statistics_current_month': 'Mês atual',
  'paywall_free_trial': '7 DIAS GRÁTIS',
  'paywall_free_trial_days': 'TESTE GRÁTIS DE {days} DIAS',
  'paywall_free_trial_generic': 'TESTE GRÁTIS',
